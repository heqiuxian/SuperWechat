...
public class UserProfileActivity extends BaseActivity implements OnClickListener {
    ...
    @OnClick({R.id.iv_title_back, R.id.layout_userinfo_avatar, R.id.layout_userinfo_nick, R.id.layout_userinfo_name})
