...
public class InviteMessgeDao {
	...
	public Integer saveMessage(InviteMessage message){
		return SuperWechatDBManageroo.getInstance().saveMessage(message);
	}
	...
	public void updateMessage(int msgId,ContentValues values){
	    SuperWechatDBManageroo.getInstance().updateMessage(msgId, values);
	}
	...
	public List<InviteMessage> getMessagesList(){
		return SuperWechatDBManageroo.getInstance().getMessagesList();
	}
	
	public void deleteMessage(String from){
	    SuperWechatDBManageroo.getInstance().deleteMessage(from);
	}
	
	public int getUnreadMessagesCount(){
	    return SuperWechatDBManageroo.getInstance().getUnreadNotifyCount();
	}
	
	public void saveUnreadMessageCount(int count){
	    SuperWechatDBManageroo.getInstance().setUnreadNotifyCount(count);
	}
}
